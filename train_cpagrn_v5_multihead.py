"""
train_cpagrn_v5_multihead.py — Training script για το πείραμα Multi-Head
Neighbor Attention (βλ. model_cpagrn_multihead.py).

Πανομοιότυπο με το train_cpagrn.py, με ΜΟΝΗ διαφορά ότι εισάγει το μοντέλο
από το model_cpagrn_multihead.py αντί για model_cpagrn.py, και έχει ένα
επιπλέον CLI argument --num_heads. Δεν αγγίζει καθόλου το train_cpagrn.py
ή το model_cpagrn.py — πλήρως ανεξάρτητο αρχείο.

Usage:
    python train_cpagrn_v5_multihead.py --obs_len 10 --pred_len 10 --seed 42 \
        --num_heads 4 --tag CPAGRN_v5_multihead4_obs10_pred10_s42 --gpu_num 0
"""
...
from model_cpagrn_multihead import CPAGRN, cpagrn_loss
...
def get_args():
    ...
    p.add_argument('--tag',            type=str,   default='CPAGRN_v5_multihead')
...
def main():
    ...
    log.info(f'Model: model_cpagrn_multihead.CPAGRN (πείραμα v6 — multi-head attention)')
